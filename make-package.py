...
os.system("cp COPYING.txt COPYING-backtrace.txt CREDITS-wolfcam.txt CREDITS-openarena.txt README-ioquake3.txt README-wolfcam.txt version unifont-LICENSE.txt voip-readme.txt %s/" % packageDir)
