#!/bin/sh
echo "Edit this script to change the path to ioquake3's dedicated server execut
able"
...
~/ioquake3/ioq3ded +set dedicated 2 +set sv_allowDownload 1 +set sv_dlURL \"\" +set com_hunkmegs 64 "$@"
