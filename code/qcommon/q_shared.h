...
#define DEFAULT_REDTEAM_NAME		"Red Team"
#define DEFAULT_BLUETEAM_NAME		"Blue Team"
...
qboolean Q_IsColorStringPicString(const floatint_t *p);  // ^[0-9a-zA-Z]
...
extern vec4_t	g_color_table_q3[8];
...
#define Vector4Copy(a,b)		((b)[0]=(a)[0],(b)[1]=(a)[1],(b)[2]=(a)[2],(b)[3]=(a)[3])
#define Vector4Set(v, x, y, z, a)	((v)[0]=(x), (v)[1]=(y), (v)[2]=(z), (v)[3]=(a))
