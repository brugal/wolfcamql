...
================
*/
static void ResampleSfx( sfx_t *sfx, int inrate, int inwidth, const byte *data, qboolean compressed ) {
	int		outcount;
	int		srcsample;
	float	stepscale;
	int		i;
...
================
*/
static int ResampleSfxRaw( short *sfx, int inrate, int inwidth, int samples, const byte *data ) {
	int			outcount;
	int			srcsample;
	float		stepscale;
	int			i;
