...
equ     trap_R_DrawConsoleLines                         -114
equ     trap_Key_GetBinding                           -115
equ     trap_GetLastExecutedServerCommand               -116
equ     trap_GetNextKiller                              -117
equ     trap_GetNextVictim                              -118
equ     trap_ReplaceShaderImage                         -119
equ     trap_RegisterShaderFromData                     -120
equ     trap_GetShaderImageDimensions                   -121
equ     trap_GetShaderImageData                         -122
equ     trap_PeekSnapshot                               -123
equ     trap_CalcSpline                                 -124
equ     trap_SetPathLines                               -125
equ trap_GetGameStartTime -126
equ trap_GetGameEndTime -127
equ trap_GetFirstServerTime -128
equ trap_GetLegsAnimStartTime -129
equ trap_GetTorsoAnimStartTime -130
equ trap_R_RegisterShaderLightMap -131
equ trap_autoWriteConfig -132
equ trap_SendConsoleCommandNow -133
equ powf -134
equ trap_R_ClearRemappedShader -135
