...
#if !defined( Q3_VM ) || ( defined( Q3_VM ) && defined( __Q3_VM_Q3MME_MATH ) )
...
extern void QuatAdd( const Quat_t q0, const Quat_t q1, Quat_t qr);
extern void QuatSub( const Quat_t q0, const Quat_t q1, Quat_t qr);
extern void QuatScale( const Quat_t q0, float scale,Quat_t qr);
extern void QuatScaleAdd( const Quat_t q0, const Quat_t q1, float scale, Quat_t qr);
extern float QuatLengthSquared( const Quat_t q );
extern float QuatLength( const Quat_t q );
extern void QuatClear( Quat_t q );
extern float QuatNormalize( Quat_t q );
extern void posMatrix( float t, posInterpolate_t type, vec4_t matrix);
extern void posGet( float t, posInterpolate_t type, const vec3_t control[4], vec3_t out);
extern vec_t VectorDistanceSquared ( const vec3_t v1, const vec3_t v2 );
extern vec_t VectorDistance( const vec3_t v1, const vec3_t v2 );
extern void AnglesNormalize360( vec3_t angles);
extern void AnglesNormalize180( vec3_t angles);
