...
typedef struct shader_s {
  ...
  struct shader_s *gameRemappedShader;                  // current shader this one is remapped too
  struct shader_s *userRemappedShader;
  qboolean remappedShaderKeepLightmap;
...
typedef struct {
	...
	shaderProgram_t rectScreenShader;
	...
	//GLuint cpvao;
	GLuint cpvbo;
	GLuint cpshaderprogram;
	GLuint cpvertexshader;
...
extern cvar_t	*r_cloudHeight;
extern cvar_t 	*r_cloudHeightOrig;
extern cvar_t	*r_forceSky;
...
extern	cvar_t	*r_singleShaderName;
...
extern	cvar_t	*r_lightmapColor;
extern	cvar_t	*r_darknessThreshold;
...
extern	cvar_t	*r_greyscaleValue;
extern	cvar_t	*r_mapGreyScale;
extern  cvar_t  *r_picmipGreyScale;
extern  cvar_t  *r_picmipGreyScaleValue;

extern	cvar_t	*r_ignoreGLErrors;

extern	cvar_t	*r_overBrightBits;
extern	cvar_t	*r_overBrightBitsValue;
...
extern cvar_t *r_BloomTextureScale;
...
void    R_RemapShader(const char *oldShader, const char *newShader, const char *timeOffset, qboolean keepLightmap, qboolean userSet);
...
typedef struct shaderCommands_s 
{
	...
	shader_t	*shader;
	shader_t *originalShader;  // if set 'shader' is a remapped shader, use this shader for the original lightmap
	double		shaderTime;
	int			fogNum;
	int         cubemapIndex;
