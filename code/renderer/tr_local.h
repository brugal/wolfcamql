...
typedef struct {
	...
	float		projectionMatrixDepthHack[16];
	cplane_t	frustum[4];
	vec3_t		visBounds[2];
	float		zFar;
	stereoFrame_t	stereoFrame;
...
typedef struct {
	...
	// glsl shader programs and shaders
	...
	qboolean usingFrameBufferObject;
...
//extern cvar_t *r_anaglyphModeFullRgb;
