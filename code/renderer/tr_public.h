...
typedef struct {
	...
	void (*SetPathLines)(int *numCameraPoints, cameraPoint_t *cameraPoints, int *numSplinePoints, vec3_t *splinePoints, vec4_t color);
	...
	qhandle_t (*RegisterShaderFromData) (const char *name, const ubyte *data, int width, int height, qboolean mipmap, qboolean allowPicmip, int wrapClampMode, int lightmapIndex);
